...
! function(e) {
    ...
    var l = function() {
        ...
        }], (t = null) && o(a.prototype, t), l && o(a, l), e
    }();
    a.default = l
}, function(e, a, t) {
    "use strict";
            ...
            return a = e, o = [{
                ...
                value: function() {
                    jQuery('[data-toggle="scroll-to"]:not(.js-scroll-to-enabled)').on("click.pixelcave.helpers.core", function(e) {
                        ...
                        var a = jQuery("#page-header"),
                            ...
                            l = t.data("speed") || 1e3,
                            n = a.length && jQuery("#page-container").hasClass("page-header-fixed") ? a.outerHeight() : 0;
                        t.addClass("js-scroll-to-enabled"), jQuery("html, body").animate({
                            scrollTop: jQuery(o).offset().top - n
                        }, l)
                    })
                }
            }, {
                ...
                value: function() {
                    jQuery('[data-toggle="appear"]:not(.js-appear-enabled)').each(function(e, a) {
                        var t = l.default.getWidth(),
                            o = jQuery(a),
                            n = o.data("class") || "animated fadeIn",
                            r = o.data("offset") || 0,
                            i = t < 992 ? 0 : o.data("timeout") ? o.data("timeout") : 0;
                        o.addClass("js-appear-enabled").appear(function() {
                            setTimeout(function() {
                                o.removeClass("invisible").addClass(n)
                            }, i)
                        }, {
                            accY: r
                        })
                    ...
                    jQuery('[data-toggle="click-ripple"]:not(.js-click-ripple-enabled)').each(function(e, a) {
                        ...
                        t.addClass("js-click-ripple-enabled").css({
                            ...
                            0 === t.children(".click-ripple").length ? t.prepend('<span class="click-ripple"></span>') : t.children(".click-ripple").removeClass("animate"), (a = t.children(".click-ripple")).height() || a.width() || (o = Math.max(t.outerWidth(), t.outerHeight()), a.css({
                                height: o,
                                width: o
                            })), l = e.pageX - t.offset().left - a.width() / 2, n = e.pageY - t.offset().top - a.height() / 2, a.css({
                                top: n + "px",
                                left: l + "px"
                            }).addClass("animate")
                        })
                        ...
                        o.addClass("js-table-checkable-enabled"), jQuery("thead input:checkbox", o).on("click.pixelcave.helpers", function(a) {
                            ...
                            if (!("checkbox" === a.target.type || "button" === a.target.type || "a" === a.target.tagName.toLowerCase() || jQuery(a.target).parent("a").length || jQuery(a.target).parent("button").length || jQuery(a.target).parent(".custom-control").length || jQuery(a.target).parent("label").length)) {
                                var t = jQuery("input:checkbox", a.currentTarget),
                                    o = t.prop("checked");
                                t.prop("checked", !o), e.tableToolscheckRow(t, !o)
                            }
                        })
                    })
                }
                ...
                value: function() {
                    ...
                    jQuery(".js-sparkline:not(.js-sparkline-enabled)").each(function(a, t) {
                        var o = jQuery(t),
                            ...
                            s = {
                                line: function() {
                                    n.type = l, n.lineWidth = o.data("line-width") || 2, n.lineColor = o.data("line-color") || "#0665d0", n.fillColor = o.data("fill-color") || "#0665d0", n.spotColor = o.data("spot-color") || "#495057", n.minSpotColor = o.data("min-spot-color") || "#495057", n.maxSpotColor = o.data("max-spot-color") || "#495057", n.highlightSpotColor = o.data("highlight-spot-color") || "#495057", n.highlightLineColor = o.data("highlight-line-color") || "#495057", n.spotRadius = o.data("spot-radius") || 2, n.tooltipFormat = "{{prefix}}{{y}}{{suffix}}"
                                },
                                bar: function() {
                                    n.type = l, n.barWidth = o.data("bar-width") || 8, n.barSpacing = o.data("bar-spacing") || 6, n.barColor = o.data("bar-color") || "#0665d0", n.tooltipFormat = "{{prefix}}{{value}}{{suffix}}"
                                },
                                pie: function() {
                                    n.type = l, n.sliceColors = ["#ffb119", "#8dc451", "#3c90df", "#e04f1a"], n.highlightLighten = o.data("highlight-lighten") || 1.1, n.tooltipFormat = "{{prefix}}{{value}}{{suffix}}"
                                },
                                tristate: function() {
                                    n.type = l, n.barWidth = o.data("bar-width") || 8, n.barSpacing = o.data("bar-spacing") || 6, n.posBarColor = o.data("pos-bar-color") || "#82b54b", n.negBarColor = o.data("neg-bar-color") || "#e04f1a"
                                }
                            };
                        s[l] ? (s[l](), n.width = o.data("width") || "120px", n.height = o.data("height") || "80px", n.tooltipPrefix = o.data("tooltip-prefix") ? o.data("tooltip-prefix") + " " : "", n.tooltipSuffix = o.data("tooltip-suffix") ? " " + o.data("tooltip-suffix") : "", "100%" === n.width ? i || (i = !0, jQuery(window).on("resize.pixelcave.helpers.sparkline", function(a) {
                            clearTimeout(r), r = setTimeout(function() {
                                e.sparkline()
                            }, 500)
                        })) : jQuery(t).addClass("js-sparkline-enabled"), jQuery(t).sparkline(o.data("points") || [0], n)) : console.log("[jQuery Sparkline JS Helper] Please add a correct type (line, bar, pie or tristate) in all your elements with 'js-sparkline' class.")
                    })
                }
        ...
        return a = e, (t = [{
            ...
            value: function() {
                ...
                if (a) {
                    ...
                    t && o.default.updateTheme(e, t), e = jQuery("#css-theme")
                }
                jQuery('[data-toggle="theme"][data-theme="' + (e.length ? e.attr("href") : "default") + '"]').addClass("active"), this._lPage.off("click.pixelcave.themes"), this._lPage.on("click.pixelcave.themes", '[data-toggle="theme"]', function(t) {
                    t.preventDefault();
                    var l = jQuery(t.currentTarget),
                        n = l.data("theme");
                    jQuery('[data-toggle="theme"]').parent("li").removeClass("active"), jQuery('[data-toggle="theme"][data-theme="' + n + '"]').parent("li").addClass("active"), o.default.updateTheme(e, n), e = jQuery("#css-theme"), a && Cookies.set("dashmixThemeName", n, {
                        expires: 7
                    }), l.blur()
                })
            }
            ...
            value: function() {
                var e, a, t, o = this,
                    l = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "init",
                    ...
                    s = {
                        init: function() {
                            ...
                            }), r._lPage.off("click.pixelcave.blocks"), r._lPage.on("click.pixelcave.blocks", '[data-toggle="block-option"]', function(e) {
                ...
                "init" === l ? s[l]() : (e = n instanceof jQuery ? n : jQuery(n)).length && (a = jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]', e), t = jQuery('[data-toggle="block-option"][data-action="content_toggle"]', e), s[l] && s[l]())
            }
        }, {
            key: "init",
            value: function() {
    ...
    function r(e, a) {
        return !a || "object" !== n(a) && "function" != typeof a ? function(e) {
    ...
    var i = function(e) {
        function a() {
            ...
            return function(e, a) {
                if (!(e instanceof a)) throw new TypeError("Cannot call a class as a function")
            //untuk mengganti redirect: hostname
            }(this, a), e = r(this, (a.__proto__ || Object.getPrototypeOf(a)).call(this)), "localhost" !== dashmix.ekuiva.com.hostname && ($("body").html(""), location.href = "dashmix.ekuiva.com"), e
        }
        return function(e, a) {
    ...
    a.default = i, jQuery(function() {
        window.Dashmix = new i
    })
}, function(e, a, t) {
    e.exports = t(4)
}]);